...
using namespace std;
using namespace cv;
using namespace liblsvm;

static void help();
static void readDirectory( const string& directoryName, vector<string>& filenames, bool addDirectoryName = true );
static void detectAndDrawObjects( Mat& image, CLSVMDetector& detector, const vector<Scalar>& colors, float overlapThreshold, int numThreads );
...
int main(int argc, char* argv[])
{
    ...
    CLSVMDetector detector( models_filenames );
    if( detector.empty() )
    {
...
static void detectAndDrawObjects( Mat& image, CLSVMDetector& detector, const vector<Scalar>& colors, float overlapThreshold, int numThreads )
{
    vector<CLSVMDetector::ObjectDetection> detections;
    ...
    {
        const CLSVMDetector::ObjectDetection& od = detections[i];
