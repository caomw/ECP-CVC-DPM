...
//#include "CvLSVMRead/_lsvm_types.h"
...
public:
	...
	// Import model from OpenCV structure
	void importFromOpenCVModel( int numFilters, int numComponents, int* numPartFilters, float* bias, CvLSVMFilterObject** filters );
