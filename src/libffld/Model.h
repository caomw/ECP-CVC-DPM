...
public:
	...
	void importOpenCVModel( int start, int end, int nModelID, float* bias, CvLSVMFilterObject** filters );
...
private:
	...
	static void DT1D(const Scalar * x, int n, Scalar a, Scalar b, Scalar * z, int * v, Scalar * y, int * m = 0, int offset = 0, const Scalar * t = 0, int incx = 1, int incy = 1, int incm = 1);
